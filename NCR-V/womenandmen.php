...
$sql = "SELECT * FROM wam ORDER BY created_at DESC";  
...
?>
    ...
    <html lang="en">
        <head>
            <meta charset="UTF-8">
            <title>Women and Men - PSA Digital Library</title>
        ...
        <body>
            <div class="content">
                <h1><span class="text-highlight">WOMEN AND MEN</span></h1>
