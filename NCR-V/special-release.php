...
$sql = "SELECT * FROM special_releases ORDER BY created_at DESC";
...
<head>
    <meta charset="UTF-8">
    <title>Special Releases - PSA Digital Library</title>
...
<body>
    <div class="content">
        <h1><span class="text-highlight">SPECIAL RELEASES</span></h1>
    ...
    <script>
        function loadData(page = 1, query = '') {
            $('#release-table').fadeOut(200, function () {
                $.ajax({
                    url: 'fetch_special_releases.php',
                    type: 'POST',
