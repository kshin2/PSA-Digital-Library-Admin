...
$sql = "SELECT * FROM establishments ORDER BY created_at DESC";
...
<head>
    <meta charset="UTF-8">
    <title>Establishments - PSA Digital Library</title>
...
<body>
    <div class="content">
        <h1><span class="text-highlight">ESTABLISHMENTS</span></h1>
